...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/SaveCurDocToMarkdown.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _SaveToMarkdownEx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SaveToMarkdownEx */ "./src/SaveToMarkdownEx.js");
...
function startConverterOnClick(e) {
    e.preventDefault();
    const doc = _WizInterface__WEBPACK_IMPORTED_MODULE_2__["WizExplorerWindow"].CurrentDocument;
    ...
    Object(_SaveToMarkdownEx__WEBPACK_IMPORTED_MODULE_3__["default"])(doc, filePath, charset);
}

$(document).ready(function(){
    $('#fileName').val(_WizInterface__WEBPACK_IMPORTED_MODULE_2__["WizExplorerWindow"].CurrentDocument.Title);

    $('#chooseFilePath').on('click', function(e){
        e.preventDefault();
        const filePath = _WizInterface__WEBPACK_IMPORTED_MODULE_2__["WizCommonUI"].SelectWindowsFolder('请选择要保存到的文件夹');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return convertDocToMarkdown; });
/* harmony import */ var _WizInterface__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./WizInterface */ "./src/WizInterface.js");
const html2markdown = __webpack_require__(/*! ./lib/html2markdown/index */ "./src/lib/html2markdown/index.js");
const he = __webpack_require__(/*! he */ "./node_modules/he/he.js");


function wizImageToMarkdown(html) {
    const imgArray = _WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizCommonUI"].HtmlExtractTags(html, 'img', '', '');
    for ( imgStr of imgArray ) {
        const title = _WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizCommonUI"].HtmlTagGetAttributeValue(imgStr, 'title');
        const src = _WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizCommonUI"].HtmlTagGetAttributeValue(imgStr, 'src');
...
function convertDocToMarkdown(doc, filePath, charset) {
    ...
    if (!isMarkdown) {
        Object(_WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizAlert"])('该文档非Markdown');
        return false;
    }
    ...
    if (filePath && charset) {
        ...
        _WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizCommonUI"].CreateDirectory(fileFolder);
        // 保存图片
        const ziwFileName = doc.FileName;
        _WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizCommonUI"].HtmlConvertZipFileToHtmlFile(ziwFileName, fileFolder + '/index.html', fileName);
        _WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizCommonUI"].DeletePathFile(fileFolder + '/index.html'); //删除不需要的html
        // 解析ziw
        const html = doc.GetHtml();
        let body = _WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizCommonUI"].HtmlExtractTags(html, 'body', '', '')[0];
        body = body.replace(/\s|&nbsp;/g, '\u0020'); // 将空格统一为转化成半角空格
        let text = html2markdown( body ); //用WizTools.dll的导出方法试一下
        // 后处理实体字符避免解析错误
        text = he.decode(text); // 处理其他实体字符
        // 导出文档
        _WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizCommonUI"].SaveTextToFile(destFileName, text, charset);
        _WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizExplorerWindow"].CloseHtmlDialog(window.WizChromeBrowser, null);

        return true;
    } else {
        Object(_WizInterface__WEBPACK_IMPORTED_MODULE_0__["WizBubbleMessage"])('转化失败', '参数不合法！');
        return false;
    }
}
...
/***/ "./src/lib/html2markdown/html2markdown.js":
/*!************************************************!*\
  !*** ./src/lib/html2markdown/html2markdown.js ***!
  \************************************************/
/*! no static exports found */
...
/***/ "./src/lib/html2markdown/index.js":
/*!****************************************!*\
  !*** ./src/lib/html2markdown/index.js ***!
  \****************************************/
/*! no static exports found */
...
var html2markdown = __webpack_require__(/*! ./html2markdown */ "./src/lib/html2markdown/html2markdown.js");
var htmlParser = __webpack_require__(/*! ./markdown_html_parser */ "./src/lib/html2markdown/markdown_html_parser.js");
...
/***/ "./src/lib/html2markdown/markdown_html_parser.js":
/*!*******************************************************!*\
  !*** ./src/lib/html2markdown/markdown_html_parser.js ***!
  \*******************************************************/
/*! no static exports found */
